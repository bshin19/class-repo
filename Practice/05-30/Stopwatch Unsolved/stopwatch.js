...
var stopwatch = {
  ...
  start: function() {
    ...
    if (!clockRunning) {
      ...
      //alternative intervalID = setInterval(stopwatch.count, 1000);
    }
  ...
  recordLap: function() {
    ...
    var timeResult = stopwatch.timeConverter(stopwatch.time);

    //  TODO: Add the current lap and time to the "laps" div.

    $("#laps").append("Lap " + stopwatch.lap + ":" + timeResult + "<br>");
