...
public class ConsoleIO {
  ...
  static void getNext(Scanner input, HashMap<String, String> student, String key) {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      String[] keys = { "first name", "last name", "middle name", "address", "email", "phone number" };
       ...
       *
       * getNext(input, student, "first name", false); getNext(input, student,
       * "last name", false); getNext(input, student, "middle name", false);
       * 
       * getNext(input, student, "address", true); getNext(input, student, "email",
       * false); getNext(input, student, "phone number", false);
       */
