...
public class ConsoleIO {
  ...
  public static void main(String[] args) {
     ...
     *
     * You'll also want to create your student HashMap here. What key/value types do
     * you use for it?
     *
     * Finally, initialize an ArrayList of students. Inside of the <Type Brackets>,
     * put the type of the HashMap you created. This isn't hard, but it will look
     * weird--ask a TA to verify if your solution is correct!
     *
     *************************************************************************/
    ...
    while (true) {
      ...
      /*
       * Refactor this to print the value of each key iteratively. Use String.format,
       * and substitute the key/value names into the string.
       */
