...
public class ConsoleIO {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      /*
       * Each of these "groups" can be wrapped up into a function that takes the name
       * of a key, and a HashMap whose keys/values to update.
       *
       * It should print a string formatted against the key, and associate that key
       * with the user's input.
       *
       * Replace each of these "three line chunk" with a call to this function. You
       * can get creative and and condense it into a loop, but that's not required.
       * Consider it an extra challenge for when you finish the rest.
       */
      ...
      student.forEach((attribute, value) -> {
        System.out.println(String.format("The student's %s is %s.", attribute, value));
      });

      /*
       * Create a function that accepts a Scanner and a message to print, and returns
       * the value the user enters for confirmation.
       *
